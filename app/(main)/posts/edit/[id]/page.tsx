...
const {toast} = useToast()
    ...
    const handleSubmitFn = (data: z.infer<typeof formSchema>) =>{
...
const formattedDate = `${year}-${month}-${day}`;
    ...
    description: `Updated by ${post?.author} on ${formattedDate}`,
   })
  ...
  return (
    ...
    <FormField
      ...
      render={({ field }) => (
    <FormItem>
      <FormLabel className="uppercase text-xs font-bold text-zinc-500  dark:text-whte">Title</FormLabel>
      <FormControl>
...
/>
    <FormField
      ...
      render={({ field }) => (
    <FormItem>
      <FormLabel className="uppercase text-xs font-bold text-zinc-500  dark:text-whte">Body</FormLabel>
      <FormControl>
...
/>
    <FormField
      ...
      render={({ field }) => (
    <FormItem>
      <FormLabel className="uppercase text-xs font-bold text-zinc-500  dark:text-whte">Author</FormLabel>
      <FormControl>
...
/>
    <FormField
      ...
      render={({ field }) => (
    <FormItem>
      <FormLabel className="uppercase text-xs font-bold text-zinc-500  dark:text-whte">Date</FormLabel>
      <FormControl>
